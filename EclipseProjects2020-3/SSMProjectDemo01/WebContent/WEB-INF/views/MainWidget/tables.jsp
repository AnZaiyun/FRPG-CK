        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#Tables" aria-expanded="true" data-toggle="collapse"> <i class="icon-padnote"></i>AllTables</a>
			  <ul id="Tables" class="list-unstyled collapse show" >
			    <li class="active"><a href="/SSMProjectDemo01/MainForm/tables">Role</a></li>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
                  ...
                  <div class="table-responsive"> 
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          <th>#</th>
                          <c:forEach var="name" items = "${requestScope.roleTable}">
                          <c:if test="${name != 'rnum'}"><th>${name}</th></c:if>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="/SSMProjectDemo01/tables/delRole?Roleid=${role.rid}&curpage=${param.curpage}" >删除</a></td>
                          <td><a href="/SSMProjectDemo01/MainForm/forms?Roleid=${role.rid}" >添加</a></td>
                        </tr>
                        </c:forEach>
              ...
              <div class="col-lg-12">
                <div class="block margin-bottom-sm">
                  <div class="title"><strong>ZB</strong></div>
                  <div class="table-responsive"> 
                    <table class="table">
                      <thead>
                        <tr>
                          <th>#</th>
                          <c:forEach var="name" items = "${requestScope.zbTable}">
                          <c:if test="${name != 'zbnum'}"><th>${name}</th></c:if>
                          </c:forEach>
                        </tr>
                      </thead>
                      <tbody>
