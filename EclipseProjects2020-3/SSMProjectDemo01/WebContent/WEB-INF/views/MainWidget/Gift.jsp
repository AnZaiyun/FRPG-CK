        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#Tables" aria-expanded="true" data-toggle="collapse"> <i class="icon-padnote"></i>AllTables</a>
			  <ul id="Tables" class="list-unstyled collapse show" >
			    ...
			    <li class="active"><a href="/SSMProjectDemo01/MainForm/usergift">Gift</a></li>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="block margin-bottom-sm">
                  <div class="title"><strong>Gift</strong></div>
                  <div class="table-responsive"> 
                 
                  			<td><a href='/SSMProjectDemo01/MainForm/usergift?curpage=1'>首页</a></td><a>|</a>
                  			<c:choose>
                        		<c:when test="${param.curpage <= 1}">
                        			<td><a href=''>上一页</a></td><a>|</a>
                        		</c:when>
                        		<c:otherwise>
                        			<td><a href='/SSMProjectDemo01/MainForm/usergift?curpage=${param.curpage-1}'>上一页</a></td><a>|</a>
                        		</c:otherwise>
                        	</c:choose>
                      	 	
                        		<c:forEach var="i" begin="1" end="${requestScope.giftPage}">
                        		
                        			<td><a  href='/SSMProjectDemo01/MainForm/usergift?curpage=${i}' >${i}</a></td>
                        		
                        		</c:forEach>
                        	
                        	<c:choose>
                        		<c:when test="${param.curpage >=  requestScope.giftPage}">
                        			<a>|</a><td><a href=''>下一页</a></td><a>|</a>
                        		</c:when>
                        		<c:otherwise>
                        			<a>|</a><td><a href='/SSMProjectDemo01/MainForm/usergift?curpage=${param.curpage+1}'>下一页</a></td><a>|</a>
                        		</c:otherwise>
                        	</c:choose>
                        	<td><a href='/SSMProjectDemo01/MainForm/usergift?curpage=${requestScope.giftPage}'>末页</a></td>
                        
                    <table class="table">
                      <thead>
                        <tr>
                          <th></th>
                          <c:forEach var="name" items = "${requestScope.giftTable}">
                          	<th>${name}</th>
                      ...
                      <tbody>
                        <c:forEach var="gift" items = "${requestScope.userGifts}">
                        <tr>
                          <th scope="row"></th>
                          <td>${gift.lnum}</td>
                          <td>${gift.gname}</td>
